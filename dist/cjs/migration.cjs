...
exports.LuciformXMLParserCompat = void 0;
exports.migrateToNewParser = migrateToNewParser;
 ...
 */
class LuciformXMLParserCompat {
    constructor(content, options = {}) {
        this.parser = new index_1.LuciformXMLParser(content, options);
    }
    /**
...
exports.LuciformXMLParserCompat = LuciformXMLParserCompat;
/**
...
<root>
  ...
  `.trim();
    try {
        ...
        const newParser = new index_1.LuciformXMLParser(testXML);
